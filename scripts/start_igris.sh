...
export IGRIS_RANK_MAX_STEPS="${IGRIS_RANK_MAX_STEPS:-80}"
export IGRIS_LARGE_MISSION_REASONING_TIMEOUT="${IGRIS_LARGE_MISSION_REASONING_TIMEOUT:-180}"
export IGRIS_BASELINE_CACHE_SECONDS="${IGRIS_BASELINE_CACHE_SECONDS:-3600}"
export IGRIS_FORCE_PREEMPTIVE_DECOMPOSITION="${IGRIS_FORCE_PREEMPTIVE_DECOMPOSITION:-true}"
export IGRIS_PREFER_DETERMINISTIC_DECOMPOSITION="${IGRIS_PREFER_DETERMINISTIC_DECOMPOSITION:-true}"
...
echo "Log:  $LOG_FILE"
echo "PID:  $PID_FILE"
echo "Profile: fast-autonomous (steps=$IGRIS_RANK_MAX_STEPS timeout=$IGRIS_LARGE_MISSION_REASONING_TIMEOUT)"
